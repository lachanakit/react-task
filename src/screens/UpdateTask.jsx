  ...
  return (
    <>
      <div className="w-8/12 border border-amber-500 shadow-md rounded p-6 mx-auto mt-20 flex flex-col items-center">
        ...
        <form className='w-full' onSubmit={updatehandle}>
          <div>
          ...
          <div className='mt-10'>
            <button type='submit' className='w-full bg-sky-400 hover:bg-emerald-500 p-2 text-white rounded cursor-pointer text-xl'>Save Edit</button>
          </div>
